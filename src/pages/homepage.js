    ...
    <section className="section position-relative">
      <Container>
          <Row className="align-items-center">
            <Col lg={6}>
              <div className="intro pr-lg-5" id="text-intro" data-testid="text-intro">
                ...
                <a href="/play" className="btn btn-warning" id="play-button" data-testid="play-button">
                PLAY GAME <span className="ml-2 right-icon">&#8594;</span>
                </a>
              </div>
            </Col>
            <Col lg={6}>
              <div className="mt-5 mt-lg-0" id="video-embed" data-testid="video-embed">
